...
--metric ip_float \
--result_index_path /workspace/NGFix/data/t2i-10M/t2i_10M_HNSW_NGFix_M${M}_efC${efC}_MEX${MEX}_AKNN${efC_AKNN}_Delete2M.index \
...
--metric ip_float --K 100 --result_path /workspace/NGFix/data/t2i-10M/test_t2i_10M_HNSW_NGFix_M${M}_efC${efC}_MEX${MEX}_AKNN${efC_AKNN}_Delete2M.csv \
--index_path /workspace/NGFix/data/t2i-10M/t2i_10M_HNSW_NGFix_M${M}_efC${efC}_MEX${MEX}_AKNN${efC_AKNN}_Delete2M.index \
