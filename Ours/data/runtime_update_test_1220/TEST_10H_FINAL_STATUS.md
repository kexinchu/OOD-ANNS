...
### 数据配置
- **Base Index**: ./data/comparison_10M/base.index ✅
...
### 索引配置
- **原始大小**: 10M elements
- **Resize后**: 13.6M elements
- **允许插入数**: 3.6M (10小时 × 100 QPS × 60秒)

### 当前状态
- **进程PID**: 358646
- **运行状态**: ✅ 正常运行中
- **已完成**: 6/600 分钟 (1%)
- **Insert操作**: ✅ 正常（每分钟左右5000个）

### 监控
- **监控脚本**: 已启动（每5分钟检查一次）
- **监控日志**: data/runtime_update_test/monitor_10h.log
...
### 注意事项
- 测试将在后台运行10小时
- 每分钟自动记录统计数据（recall、NDC、latency）
- 如果测试意外停止，检查nohup_ngfix.out日志文件
